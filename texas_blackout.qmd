...
plot(feb7_cropped, axes = TRUE, main = "Febuary 7 2021 night lights", cex.axis = 0.7, col = colfunc(1000), ) #key.lab = "luminescence")
plot(feb16_cropped, axes = TRUE, main = "Febuary 16 2021 night lights", cex.axis = 0.7, col = colfunc(1000)) #key.lab = "luminescence")
